...
class M_z extends Model
{
    ...
    public function getDetailRS($id_rs)
{
    return $this->db->table('rumah_sakit')
        ->join('daftar_penyakit', 'rumah_sakit.id_rs = daftar_penyakit.id_rs')
        ->where('rumah_sakit.id_rs', $id_rs)
        ->get()->getResult();
}
